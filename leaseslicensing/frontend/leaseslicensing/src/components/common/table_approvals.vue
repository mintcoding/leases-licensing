...
export default {
    ...
    methods: {
        ...
        sendData: function(params){
            let vm = this
            fetch(helpers.add_endpoint_json(api_endpoints.approvals, params.approval_id + '/request_new_stickers'), 
                {
                    method: 'post',
                    body: params,
                }).then(
                res => {
                    helpers.post_and_redirect('/sticker_replacement_fee/', {'csrfmiddlewaretoken' : vm.csrf_token, 'data': JSON.stringify(res.json())});
                },
                err => {
                    console.log(err)
                }
        ...
        reissueApproval:function (proposal_id) {
            ...
            swal({
                ...
                fetch(helpers.add_endpoint_json(api_endpoints.proposal,(proposal_id+'/reissue_approval')),
                    { 
                        method: 'post',
